...
gh.scrapeContributionDataAndStats(userUrl, function(data) {
    ...
    if (data) {
        ...
        var contributionsTodayColor = commitsToday ? boldText : redText,
            currentStreakColor = currentStreak ? boldText : redText,
            totalContributionsColor = totalContributions ? boldText : redText;
        ...
        if (contributionGoalTracking) {
            ...
            console.log("Goal:", contributionGoal, boldText);
        ...
        console.log("Longest:", longestStreak, boldText);
        console.log("---");
